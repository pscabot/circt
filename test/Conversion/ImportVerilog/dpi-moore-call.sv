...
// DPI: moore.func.dpi private @my_dpi_add(input %a : !moore.i32, input %b : !moore.i32, return return : !moore.i32)
// DPI: moore.func.dpi private @my_dpi_out(input %a : !moore.i32, output b : !moore.i32)
// DPI: moore.func.dpi private @my_dpi_inout(input %a : !moore.i32, inout %b : !moore.i32, return return : !moore.i32)
// DPI: moore.func.dpi private @my_dpi_open_array(input %wd : !moore.open_uarray<i8>, ref %rd : !moore.ref<open_uarray<i8>>)
...
module DpiMooreCallTest(
  ...
  always_ff @(posedge clk)
    add_val <= my_dpi_add(in_a, in_b);

  always_comb begin
    my_dpi_out(in_a, state_val);
    inout_val = my_dpi_inout(in_b, state);
  end

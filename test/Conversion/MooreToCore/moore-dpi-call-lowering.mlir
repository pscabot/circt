...
moore.func.dpi private @dpi_add(input %a : !moore.i32, input %b : !moore.i32, return return : !moore.i32)

// CHECK: sim.func.dpi private @dpi_add(input %a : i32, input %b : i32, return return : i32)

moore.func.dpi private @dpi_out(input %val : !moore.i32, output dst : !moore.i32)

// CHECK: sim.func.dpi private @dpi_out(input %val : i32, output dst : i32)

moore.func.dpi private @dpi_inout_ret(input %val : !moore.i32, inout %state : !moore.i32, return return : !moore.i32)

// CHECK: sim.func.dpi private @dpi_inout_ret(input %val : i32, inout %state : i32, return return : i32)

moore.func.dpi private @dpi_open_array(input %wd : !moore.open_uarray<i8>, ref %rd : !moore.ref<open_uarray<i8>>)

// CHECK: sim.func.dpi private @dpi_open_array(input %wd : !llvm.ptr, ref %rd : !llvm.ptr)
...
moore.func.dpi private @dpi_void(input %val : !moore.i32)

// CHECK: sim.func.dpi private @dpi_void(input %val : i32)

...
moore.func.dpi private @dpi_open_array(in %wd : !moore.open_uarray<i8>, ref %rd : !moore.ref<open_uarray<i8>>)

// CHECK: sim.func.dpi private @dpi_open_array(in %wd : !llvm.ptr, ref %rd : !llvm.ptr)
